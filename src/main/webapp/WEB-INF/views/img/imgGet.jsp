...
<body>
							...
							<div class="col-lg-6">
								<form action="/interphone2/image/register" method="post"
									...
									<div class="form-group">
										...
										<input type="hidden" name="uhome" value=${MemberVO.uhome }
											readonly>
									</div>
									...
									<div class="form-group">
										<label>화가/작성자</label> <input class="form-control"
											placeholder="Enter text" name="artist">
									</div>

									<div class="form-group">
										<label>제목</label> <input class="form-control"
											placeholder="Enter text" name="imageText">
									</div>

									<div class="form-group">
										<label>설명</label> <input class="form-control"
											placeholder="Enter text" name="imageScript">
									</div>
	...
	<tr>
		...
		<td>
 		...
 		<c:choose> 
 			<c:when test="${empty e}"> 
 				<img src="${ImageVO.imageName}"  width="400" height="300"> 
 			</c:when> 
 			<c:otherwise> 
 				<img src="/img/nhnent_1.png" width="400" height="300">
 			 </c:otherwise>
 		 </c:choose>		
		</td>
	
        <td>
			  <input type="button" value="Add Courses" onclick="window.location.href='deleteFile/${ImageVO.imageName}';"/>  
   	   </td>
